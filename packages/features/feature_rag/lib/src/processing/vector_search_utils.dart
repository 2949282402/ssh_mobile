...
class AliyunEmbeddingClient implements RagEmbeddingPort {
  ...
  final String apiKey;
  final RagLoggerPort? logger;

  const AliyunEmbeddingClient({required this.apiKey, this.logger});
