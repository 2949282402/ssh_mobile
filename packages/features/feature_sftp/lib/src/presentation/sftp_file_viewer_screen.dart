...
class _SftpFileViewerScreenState extends State<SftpFileViewerScreen> {
  ...
  Future<_PreviewPayload> _loadPreview({required bool bypassCache}) async {
    ...
    final logger = context.read<SftpLoggerPort?>();
  ...
  Widget _buildPreviewContent(SftpStrings strings) {
  ...
  Widget _buildLoadedPreview(SftpStrings strings, _PreviewPayload payload) {
  ...
  Widget _buildHtmlPreview(SftpStrings strings, String html) {
    final theme = Theme.of(context);
  ...
  Widget _buildPdfUnavailable(SftpStrings strings) {
    return _PreviewStateView(
  ...
  int _previewLimitFor(_PreviewKind kind, SftpSettingsPort settings) {
    switch (kind) {
      case _PreviewKind.text:
      case _PreviewKind.markdown:
      case _PreviewKind.html:
...
String _previewKindLabel(_PreviewKind kind, SftpStrings strings) {
  return switch (kind) {
