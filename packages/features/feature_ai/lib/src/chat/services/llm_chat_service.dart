...
import 'package:feature_ai/src/tools/tool_exposure_router.dart';
...
import 'package:feature_ai/src/llm/provider/llm_provider_types.dart';
import 'package:feature_ai/src/llm/provider/llm_provider_adapter.dart';
import 'package:feature_ai/src/llm/provider/llm_provider_factory.dart';
import 'package:feature_ai/src/llm/provider/llm_url_utils.dart';
...
class LlmChatService implements LlmClientAdapter {
  ...
  Future<List<String>> fetchModels({
    ...
    return provider.fetchModels(baseUrl: baseUrl, apiKey: resolvedApiKey);
  }
