...
import '../../../application/playbook_service.dart';
import '../../../domain/playbook_ports.dart';
import '../models/playbook.dart';

/// Playbook Route 的编辑与执行状态；只拥有页面控制器，不拥有 Module Service。
class PlaybookViewModel extends ChangeNotifier {
  final PlaybookService _playbookService;
  final PlaybookConnectionCatalogPort _connectionCatalog;
  ...
  void dispose() {
    ...
    _connectionCatalog.removeListener(_onCatalogChanged);
