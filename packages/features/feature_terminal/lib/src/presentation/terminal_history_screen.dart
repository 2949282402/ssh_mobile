...
import '../application/terminal_history_viewmodel.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<TerminalHistoryViewModel>(
      create: (context) => TerminalHistoryViewModel(
        repository: context.read<TerminalHistoryRepository>(),
      ),
      child: page,
    );
  }
...
class TerminalHistoryPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final language = context.select<TerminalSettingsPort, Object>(
...
class _HistoryItem extends StatelessWidget {
  ...
  Future<void> _copyCommand(BuildContext context, String command) async {
    try {
      ...
      if (!context.mounted) return;
      context.read<TerminalLoggerPort>().error(
