...
void main() {
  ...
  testWidgets('loads records and preserves refresh delete and copy actions', (
    ...
    await tester.pumpWidget(_historyHost(viewModel: viewModel, language: 'en'));
    await tester.pump();
  ...
  testWidgets('empty state explains the page and can refresh', (tester) async {
    ...
    await tester.pumpWidget(_historyHost(viewModel: viewModel, language: 'zh'));
    await tester.pumpAndSettle();
  ...
  testWidgets('long content remains usable at 320dp and 200 percent text', (
    ...
    await tester.pumpWidget(
      _historyHost(viewModel: viewModel, language: 'en', textScale: 2),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        _historyHost(viewModel: viewModel, language: 'zh'),
      );
      await tester.pumpAndSettle();
...
Widget _historyHost({
  ...
  final settings = FakeTerminalSettings(language: language);
