...
class TerminalViewState extends State<TerminalView> {
  ...
  RenderTerminal? get _maybeRenderTerminal {
    ...
    return renderObject is RenderTerminal ? renderObject : null;
  }

  RenderTerminal get renderTerminal {
    final renderTerminal = _maybeRenderTerminal;
    if (renderTerminal == null) {
      throw StateError('Terminal view is not attached.');
    }
  ...
  Widget build(BuildContext context) {
    ...
    child = TerminalScrollGestureHandler(
      ...
      getCellOffset: (offset) =>
          _maybeRenderTerminal?.getCellOffset(offset) ?? const CellOffset(0, 0),
      getLineHeight: () => _maybeRenderTerminal?.lineHeight ?? 1,
      child: child,
    );
  ...
  Rect get cursorRect {
    final renderTerminal = _maybeRenderTerminal;
    if (renderTerminal == null) return Rect.zero;
