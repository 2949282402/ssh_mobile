...
pub(super) fn valid_transfer_identity(transfer_id: &str, peer_id: &str) -> bool {
...
pub(super) async fn read_bounded_utf8(
    receive: &mut RecvStream,
    maximum: usize,
    label: &str,
...
pub(super) async fn forward_progress(
    transfer_id: String,
    peer_id: String,
...
pub(super) fn is_transient_transport_error(error: &(dyn Error + 'static)) -> bool {
...
pub(super) fn transfer_failure_code(reason: TransferFailureReason) -> NetworkErrorCode {
    match reason {
