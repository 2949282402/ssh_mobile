...
enum ClientRuntimeHealthStatus { ok, warning, blocking }

enum ClientHealthCheckProfile { general, agentExecution, background }
...
abstract interface class ClientHealthAdvisorAdapter {
  Future<ClientRuntimeHealthReport> check({ClientHealthCheckProfile profile});
}
...
class ClientHealthAdvisor implements ClientHealthAdvisorAdapter {
  ...
  Future<Map<String, dynamic>> _guard(
    ...
    try {
      ...
      return {'supported': true, 'error': e.toString(), 'source': source};
    }
  }
