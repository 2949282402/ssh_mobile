...
void main() {
  ...
  testWidgets('AI workspace golden - Desktop', (tester) async {
    ...
    try {
      ...
      await expectLater(
        find.byType(ai.LlmChatScreen),
        matchesGoldenFile('goldens/ai_desktop.png'),
      );
    } finally {
      debugDefaultTargetPlatformOverride = null;
  ...
  testWidgets('AI workspace golden - Mobile', (tester) async {
    ...
    try {
      ...
      await expectLater(
        find.byType(ai.LlmChatScreen),
        matchesGoldenFile('goldens/ai_mobile.png'),
      );
    } finally {
      debugDefaultTargetPlatformOverride = null;
      tester.view.resetPhysicalSize();
