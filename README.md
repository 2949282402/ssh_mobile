...
- **GPT-5.6** was used for architecture reasoning, agent-loop and tool-safety design, complex regression analysis, test strategy, and evaluating engineering trade-offs.
