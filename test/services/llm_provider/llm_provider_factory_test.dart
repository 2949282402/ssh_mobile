...
void main() {
  group('LlmProviderFactory tests', () {
    ...
    test('throws UnimplementedError for unimplemented openAiResponses', () {
      final settings = buildSettings(LlmApiFormat.openAiResponses);
      expect(() => LlmProviderFactory.fromSettings(settings), throwsUnimplementedError);
    });

    test('throws UnimplementedError for unimplemented geminiNative', () {
