part of '../../ai_tool_service.dart';
  ...
  List<AiTool> _getClientTools(ClientToolsProvider provider, 
    ...
    return [
      ...
      AiTool(
        ...
        parallelSafeReadOnly: true,
        handler: (_) async =>
            jsonEncode(await provider.clientSystemToolService.getPermissionStatus()),
      ),
      AiTool(
      ...
      AiTool(
        ...
        executionMode: AiToolExecutionMode.stateChanging,
        handler: (args) =>
            _clientSaveExperienceSkill(provider, service, args, approvedWrite: false),
      ),
      AiTool(
      ...
      AiTool(
        ...
        executionMode: AiToolExecutionMode.stateChanging,
        handler: (arguments) => _clientUpdateSkill(provider, 
          service,
          arguments,
          approvedWrite: false,
        ),
      ...
      AiTool(
        ...
        required: const ['ids'],
        executionMode: AiToolExecutionMode.stateChanging,
        handler: (arguments) => _clientDeleteLogEntries(provider, 
          service,
          arguments,
          approvedWrite: false,
        ),
      ...
      AiTool(
        ...
        properties: const {},
        executionMode: AiToolExecutionMode.stateChanging,
        handler: (arguments) => _clientImportAppBackup(provider, 
          service,
          arguments,
          approvedWrite: false,
        ),
      ...
      AiTool(
        ...
        executionMode: AiToolExecutionMode.stateChanging,
        handler: (arguments) => _appUpdateOperationalSettings(provider, 
          service,
          arguments,
          approvedWrite: false,
        ),
      ...
      AiTool(
        ...
        handler: (args) => _clientTaskSkip(provider, service, args, approvedWrite: false),
      ),
    ];
  }
