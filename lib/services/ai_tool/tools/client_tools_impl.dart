part of '../../ai_tool_service.dart';
  ...
  Future<String> _webSearch(ClientToolsProvider provider, 
    ...
    if (settings.webSearchEngine == AiWebSearchEngine.quark) {
      final result = await _executeQuarkCloudSearch(provider, 
        service,
        query,
        limit: limit,
        settings: settings,
  ...
  Future<ClientWebViewSearchResult> _executeQuarkCloudSearch(ClientToolsProvider provider, 
  ...
  int _webSearchLimit(ClientToolsProvider provider, Object? requestedLimit, AiConnectionSettings settings) {
  ...
  Future<String> _clientSaveExperienceSkill(ClientToolsProvider provider, 
    AiToolService service,
  ...
  Future<String> _clientListSkills(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
  ...
  Future<String> _clientUpdateSkill(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
  ...
  Future<String> _clientDeleteLogEntries(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
    ...
    return jsonEncode(await provider.clientSystemToolService.deleteLogEntries(ids));
  }

  Future<String> _clientClearLogs(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
  ...
  Future<String> _clientImportAppBackup(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
  ...
  Future<String> _clientWebViewGetPageText(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final chatId = provider.clientWebViewSessionId;
  ...
  Future<String> _clientWebViewGetState(ClientToolsProvider provider, 
    ...
    return jsonEncode((await provider.clientWebViewService.getState(chatId)).toJson());
  }
  ...
  Map<String, dynamic> _summarizeBackupJson(ClientToolsProvider provider, String jsonText) {
  ...
  List<String> _backupHighRiskSections(ClientToolsProvider provider, Map<String, dynamic> decoded) {
  ...
  Future<String> _appGetOperationalSettings(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final settings = await provider.storageService.loadAiConnectionSettings();
  ...
  Future<String> _appUpdateOperationalSettings(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
  ...
  Future<String> _appClearSecretCache(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
  ...
  Future<String> _clientSetPlanMode(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final chatId = provider.clientWebViewSessionId;
  ...
  Future<String> _clientTaskCreate(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final chatId = provider.clientWebViewSessionId;
  ...
  Future<String> _clientTaskUpdate(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final chatId = provider.clientWebViewSessionId;
  ...
  Future<String> _clientTaskRetry(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments,
  ) async {
    final chatId = provider.clientWebViewSessionId;
  ...
  Future<String> _clientTaskSkip(ClientToolsProvider provider, 
    AiToolService service,
    Map<String, dynamic> arguments, {
    required bool approvedWrite,
  }) async {
