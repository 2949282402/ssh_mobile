...
extension SettingsOps on StorageService {
  ...
  // Helper SharedPreferences ops
  Future<void> _writeStringPref(String key, String value) async {
    if (_prefs == null) return;
  ...
  Future<void> _writeBoolPref(String key, bool value) async {
    if (_prefs == null) return;
    await _prefs!.setBool(key, value);
  }

  bool? _readBoolPref(String key) {
    return _prefs?.getBool(key);
  }

  Future<void> _writeIntPref(String key, int value) async {
    if (_prefs == null) return;
  ...
  Future<void> _writeDoublePref(String key, double value) async {
    if (_prefs == null) return;
    await _prefs!.setDouble(key, value);
  }

  double? _readDoublePref(String key) {
    return _prefs?.getDouble(key);
  }

  Future<void> _writeStringListPrefBuffered(
    String key,
    List<String> values, {
